  ...
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30'>
        <div className='flex flex-col md:flex-row items-center justify-between w-full '>
            <Title align={'left'} title={"Exclusive Offers"} subTitle={"Take advantage of our limited-time offers and special packages to enchance your stay and create unforgetabble memories"}/>
            <button className='flex gap-1 group cursor-pointer'>
                View All Offers
