...
const Testimonial = () => {
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 bg-slate-50 pt-20'>
        <Title title={"What Our Guest Says"} subTitle={"Discover why discenring travellers consistetly choose myStay for their exlusive and luxurious accomodations around the world."}/>
