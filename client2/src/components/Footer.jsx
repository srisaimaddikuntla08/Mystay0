         ...
         <footer className="px-6 pt-8 md:px-16 lg:px-36 w-full">
            <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500 pb-10">
                <div className="md:max-w-96">
                    <h1 className='text-4xl font-extrabold m-5'>MyStay</h1>
                  <p className='max-w-130 mt5- text-sm md:text-base'>Unparalleled luxury and comfort await at the world's most exclusive hotels and resorts,Start your journey today.</p>
