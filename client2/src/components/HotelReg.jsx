    ...
    return (
        <div className='fixed top-0 bottom-0 left-0 right-0 z-100 flex items-center justify-center bg-black/70'>
            <form className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
                <img src={assets.regImage} className='w-1/2 roundex-xl hidden md:block' alt="" />
                <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
                    ...
                    <div className='w-full mt-4'>
                        <label htmlFor="city" className='font-medium text-gray-500'>Address</label>
                    ...
                    <button className='text-white px-6 py-2 rounded cursor-pointer mt-2 mr-auto bg-indigo-500 hover:bg-indigo-600 '>Register</button>
                </div>
            </form>
        </div>
