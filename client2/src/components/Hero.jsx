...
const Hero = () => {
  return (
    ...
    className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center h-screen'>
        <p className='bg-[#49B9FF]/50 px-3.5 py-1 rounded-2xl mt-20'> The Ultimate Hotel Experience</p>
        <h1 className='text-2xl md:text-5xl md:text-[56px] md:leading-56px font-bold md:font-bold max-w-xl mt-4 '>Discover your perfect Gateway Destination</h1>
        ...
        <form className=' mt-10 bg-white text-gray-500 rounded-lg px-6 py-4  flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto'>
            <div>
            ...
            <button className='flex items-center justify-center gap-1 rounded-md bg-black py-3 px-4 text-white my-auto cursor-pointer max-md:w-full max-md:py-1' >
                <img src={assets.calenderIcon} alt='' className='h-4 mr-1' />
                <span>Search</span>
            </button>
        </form>
    </div>
